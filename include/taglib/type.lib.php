...
function lib_type(&$ctag,&$refObj)
{
  ...
  if(empty($typeid)) return '';
    ...
    $row = $dsql->GetOne("SELECT id,typename,typenamedir,typelitpic,typedir,description,content,isdefault,ispart,defaultname,namerule2,moresite,siteurl,sitepath 
