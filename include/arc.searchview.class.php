...
class SearchView
{
    ...
    $searchtype='',$starttime=0,$upagesize=20,$kwtype=1,$mid=0)
    {
        ...
        if ( defined('DEDEMOB') )
        {
            $this->Fields['position'] = "<a href='index.php'>".$GLOBALS['cfg_indexname']."</a>".$GLOBALS['cfg_list_symbol']."搜索结果";
        } else{
            $this->Fields['position'] = "<a href='".$GLOBALS['cfg_basehost'].$GLOBALS['cfg_indexurl']."'>".$GLOBALS['cfg_indexname']."</a>".$GLOBALS['cfg_list_symbol']."搜索结果";
        }
		$this->Fields['typeid'] = 999999;
		$this->Fields['title'] = "搜索结果";
		$this->Fields['typename'] = "搜索结果";
        ...
        foreach($ks as $k)
        {
            ...
            if($this->ChannelType < 0 || $this->ChannelTypeid < 0){
                ...
                if($this->SearchType=="title"){
                    ...
                    $kwsqls[] = " CONCAT(arc.title,' ',arc.writer,' ',arc.keywords,' ',arc.shorttitle) LIKE '%$k%' ";//neo
                }
            }
        }
        if(!isset($kwsqls[0]))
    ...
    function GetPageListDM($list_len,$listitem="index,end,pre,next,pageno",$pagelang)
    {
        ...
        {
            return "<li><a>".$uahome."</a></li><li><a>".$uaprevious."</a></li><li class=\"thisclass\"><a>1</a></li><li><a>".$uanext."</a></li><li><a>".$ualastpage."</a></li><li><a class=\"\">".$uatotal." 1 ".$uapage."/".$this->TotalResult."".$uarecords."</a></li>";
        }
        if($this->TotalResult == 0)
        {
            return "<li><a>".$uahome."</a></li><li><a>".$uaprevious."</a></li><li class=\"thisclass\"><a>1</a></li><li><a>".$uanext."</a></li><li><a>".$ualastpage."</a></li>";
        }
