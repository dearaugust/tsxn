...
function GetFormItem($ctag, $admintype='admin')
{
    ...
    {
        $innertext = "<textarea name='$fieldname' id='$fieldname' class='user_textarea' style='height:100px;'></textarea>\r\n";
    }
    ...
    else if($fieldType=='img'||$fieldType=='imgfile')
    {
        if($admintype=='diy') {
            ...
            $innertext = "<input type='text' name='$fieldname' id='$fieldname' style='width:300px' class='text' /> <input name='".$fieldname."_bt' type='button' class='inputbut' value='浏览...' onClick=\"SelectImageN('form1.$fieldname','big','$fieldname')\" /> <div id='div$fieldname' class='divpre'></div>\r\n";
        }
    }
...
function GetFormItemValue($ctag, $fvalue, $admintype='admin', $fieldname='')
{
    ...
    {
        $innertext = "<textarea name='$fieldname' id='$fieldname' class='user_textarea' style='height:100px;'>$fvalue</textarea>\r\n";
    }
    ...
    else if($ftype=="img")
    {
        ...
        $innertext = "<input type='text' name='$fieldname' value='$fvalue' id='$fieldname' style='width:300px'  class='text' /> <input name='".$fieldname."_bt' class='inputbut' type='button' value='浏览...' onClick=\"SelectImageN('form1.$fieldname','big','$fieldname')\" /> <div id='div$fieldname' class='divpre'><img src='$fvalue'></div>\r\n";
    }
