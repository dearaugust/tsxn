...
// 图集
    ...
    {
        $useip = GetIP();
        $iquery = "UPDATE `$addtable` SET typeid='$typeid',pagestyle='$pagestyle',maxwidth = '$maxwidth',ddmaxwidth = '$ddmaxwidth',pagepicnum = '$pagepicnum',imgurls='$imgurls',row='$row',col='$col',isrm='$isrm'{$inadd_f},redirecturl='$redirecturl',userip='$useip' WHERE aid='$id' ";// 图集
