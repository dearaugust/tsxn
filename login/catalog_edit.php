...
if($dopost=="save")
{
	...
	//英文栏目名和图片字段 by dedediy.com
    $upquery = "UPDATE `#@__arctype` SET
     issend='$issend',
     sortrank='$sortrank',
     typename='$typename',
     typenamedir='$typenamedir',
     typelitpic='$typelitpic',
     typesmallpic='$typesmallpic',
     typedir='$typedir',
     isdefault='$isdefault',
...
<td class='bline'><input name="typenamedir" type="text" id="typenamedir" size="30" value="<?php echo $myrow['typenamedir']?>" class="iptxt" /></td>
</tr>
<!--英文栏目名和图片字段 by dedediy.com-->
          <tr> 
