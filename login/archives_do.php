...
function uploadLitpic(){ }
---------------------------*/
else if($dopost=="uploadLitpic1")
{
    $upfile = AdminUpload('litpic1', 'imagelit', 0, false );
    if($upfile=='-1')
    {
        $msg = "<script language='javascript'>
                parent.document.getElementById('uploadwait').style.display = 'none';
    ...
    else
    {
         if(!empty($cfg_uplitpic_cut) && $cfg_uplitpic_cut=='N')
         {
                 $msg = "<script language='javascript'>
                    parent.document.getElementById('uploadwait').style.display = 'none';
                    parent.document.getElementById('picname1').value = '{$upfile}';
                    if(parent.document.getElementById('divpicview1'))
                    {
                        parent.document.getElementById('divpicview1').style.width = '150px';
                        parent.document.getElementById('divpicview1').innerHTML = \"<img src='{$upfile}?n' width='150' />\";
                    }
                </script>";
         }
         else
