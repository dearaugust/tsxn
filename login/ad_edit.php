...
else if($dopost=="gettag")
{
    ...
    $jscode = "<script src='{$cfg_phpurl}/ad_js.php?aid=$aid&nocache=1' language='javascript'></script>";
...
else if($dopost=='saveedit')
{
    ...
    if($img=="adimg")
	{
		...
		$normbody = "<a href=\"{$adlink}\" id=\"adimg\"><img src=\"{$adpic}\"$width $height border=\"0\" /></a>";  
	}
	//var_dump($normbody);die;
	*/
    $query = "UPDATE `#@__myad`
     SET
     clsid='$clsid',
